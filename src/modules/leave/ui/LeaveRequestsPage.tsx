  ...
  const columns: Column<LeaveRequest>[] = [
    {
      ...
      header: t('reason'),
      render: (row) => (
        <span style={{ fontWeight: 600, color: 'var(--text-heading)' }}>{t(row.reason)}</span>
      ),
    },
    {
      key: 'desc',
    ...
    },
    {
      ...
      header: t('period'),
      render: (row) => (
        <span style={{ color: 'var(--text-secondary)' }}>{row.period}</span>
      ),
    },
    {
      key: 'days',
      ...
      align: 'center',
      render: (row) => (
        <span style={{ fontWeight: 600, color: 'var(--text-heading)' }}>{row.daysCount}</span>
      ),
    },
    {
      key: 'type',
      header: t('type'),
      render: (row) => (
        <span style={{ color: 'var(--text-secondary)' }}>{t(row.type)}</span>
      ),
    },
    {
      key: 'approver',
      header: t('approver'),
      render: (row) => (
        <span style={{ color: 'var(--text-secondary)' }}>{row.approverName}</span>
      ),
    },
    {
      key: 'status',
